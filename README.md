# Dickson Lo｜Software Product Manager CV

盧駿軒 Dickson Lo 的軟體產品經理履歷網站，涵蓋 SaaS、平台產品、管理後台與
AI 工作流自動化經驗。

- 線上 CV：<https://dicksonlo901019.github.io/cv-software/>
- PDF：<https://dicksonlo901019.github.io/cv-software/dickson-lo-software-cv.pdf>
...
GitHub Actions 會自動發布。每個對外穩定版本使用 `cv-software-vYYYY.MM.DD.N` 標籤，
